...
| US4 | Generate a library status report | Sprint-3 | src/app.py->LibrarySystem.generate_report | tests/test_app.py -> test_generate_report_header,test_generate_report_contains_book | v0.3 | Planned |
